...
import (
	...
	getuserlist_mocks2 "sparkit/internal/pkg/user/delivery/getuserlist/mocks"
...
func TestGetUserListHandler(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			sessionService := getuserlist_mocks2.NewMockSessionService(mockCtrl)
			profileService := getuserlist_mocks2.NewMockProfileService(mockCtrl)
			userService := getuserlist_mocks2.NewMockUserService(mockCtrl)
			imageService := getuserlist_mocks2.NewMockImageService(mockCtrl)
			reactionService := getuserlist_mocks2.NewMockReactionService(mockCtrl)
