...
import (
	...
	signin_mocks2 "sparkit/internal/pkg/auth/delivery/signin/mocks"
...
func TestSigninHandler(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			userService := signin_mocks2.NewMockUserService(mockCtrl)
			sessionService := signin_mocks2.NewMockSessionService(mockCtrl)
