...
import (
	...
	sign_up_mocks2 "sparkit/internal/pkg/auth/delivery/signup/mocks"
...
func TestHandler(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			userService := sign_up_mocks2.NewMockUserService(mockCtrl)
			sessionService := sign_up_mocks2.NewMockSessionService(mockCtrl)
			profileService := sign_up_mocks2.NewMockProfileService(mockCtrl)
